						...
						<link type="text/css" rel="stylesheet" href="/css/a.css">
							<link type="text/css" rel="stylesheet" href="/css/a_002.css">
								<link type="text/css" rel="stylesheet" href="/css/a_003.css">
									<link href="/css/purchase.2012.css?v=201410141639"
										rel="stylesheet" type="text/css">
										<title>我的购物车 - 新巴巴商城</title> <script type="text/javascript"
											src="/js/jquery-1.6.4.js"></script>

										<script type="text/javascript">
											//全选 
											function checkAll(checked) {
												$("input[name=skuIds]").attr(
														"checked", checked);
											}
											//结算
											function trueBuy() {
										...
										<body>
											...
											<div class="w w1 header clearfix">
												<div id="logo">
													<a href="/"><img src="/images/XBB2.png"
														title="返回新巴巴商城首页" alt="返回新巴巴商城首页"></a>
												</div>
												<div class="language">
																			...
																			<div class="item_form clearfix">
																				<div class="cell p-checkbox">
																					<input class="checkbox" type="checkbox"
																						name="skuIds" value="${item.sku.id }">
																				</div>
																				<div class="cell p-goods">
																					<div class="p-img">
																						<a href="javascript:;" target="_blank"> <img
																							src="${item.sku.product.images[0]}"
																							alt="${item.sku.product.name}" width="52"
																							height="52"></a>
																					</div>
																					<div class="p-name">
																						<a href="javascrip:;">
																							${item.sku.product.name}-- ${item.sku.color.name }--
																							${item.sku.size } </a>
																					</div>
																				</div>
																...
																<div class="ui-ceilinglamp-1"
																	...
																	<div class="cart-dibu ui-ceilinglamp-current"
																		...
																		<div class="control fdibu fdibucurrent">
																			<span class="delete"> <b></b><a
																				href="javascript:void(0);">删除选中的商品</a>
																			</span> <span class="shopping"> <b></b><a href="/">继续购物</a>
																			</span>
																		</div>
																		<div class="cart-total-2014">
																			<div class="cart-button">
																				<span class="check-comm-btns"> <a
																					class="checkout" onclick="trueBuy()">去结算<b></b></a>
																				</span>
																			</div>
																			<div class="total fr">
														...
														<div class="cart-empty">
															<div class="message">
																<ul>
																	...
																	<li><a class="btn-1 login-btn mr10" href="#none">登录</a>
																		<a class="ftx-05" href="/">去购物&gt;</a></li>
																</ul>
															</div>
														</div>
													</div>
