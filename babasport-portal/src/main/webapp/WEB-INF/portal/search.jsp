	...
	<div id="J_searchWrap" class="w">
		<div id="J_crumbsBar" class="crumbs-bar">
			<div id="J_giftBox" class="cb-gift">
				<div class="cb-gift-trigger">
					<i class="ico-gift"></i> <span class="txt"> <a
						href="javascript:;">新巴巴帮您选礼物</a>
					</span>
				</div>
				<div class="cb-gift-main">
					...
					<div class="gift-btnbox">
						<a href="javascript:;" class="btn btn-primary btn-XL">搜索</a>
					</div>
				</div>
			</div>
			<div class="crumbs-nav">
				<div class="crumbs-nav-main clearfix">
					...
					<!-- 如果过滤条件的map长度部位0才显示已选条件的区块 -->
					<c:if test="${fn:length(map) != 0 }">
						<div class="sl-b-selected J_brandSelected">
							<span class="crumbs-arrow">已选条件：</span>
							<!-- 遍历map的方法，m.key  m.value -->
							<c:forEach items="${map}" var="m">
								<a title="依琦莲（yiqilian）" href="javascript:;"
									class="crumb-select-item" onclick="move('${m.key}')"> <b>${m.key}：</b><em>${m.value}</em><i></i>
								</a>
							</c:forEach>
						</div>
					</c:if>
		...
		<div id="J_container" class="container">
			<div id="J_selector" class="selector">
				<!-- 判断brandId是否为空，不为空时则表示已选择某个品牌进行过滤，隐藏品牌栏
			此处计算式内字段
				取值如果是从当前URL中取则需要写成${empty param.brandId}
			 -->
									...
									<ul class="J_valueList v-fixed">
										<c:forEach items="${brands}" var="brand">
											<li id="brand-38118" data-initial="j" style="display: block;">
												<a href="javascript:;" onclick="fqBrand('${brand.id}')"
												title="${brand.name}"><i></i>${brand.name}</a>
											</li>
										</c:forEach>
									</ul>
								</div>
				...
				<!-- 判断price是否为空，不为空时则表示已选择某个品牌进行过滤，隐藏价格栏,此处计算式内字段
				取值如果是从当前URL中取则需要写成${empty param.price}
				 -->
							...
							<div class="sl-value">
								<div class="sl-v-list">
									<ul class="J_valueList">
										<li><a href="javascript:;" onclick="fqPrice('0-99')"><i></i>0-99</a>
										</li>
										<li><a href="javascript:;" onclick="fqPrice('100-299')"><i></i>100-299</a>
										</li>
										<li><a href="javascript:;" onclick="fqPrice('300-599')"><i></i>300-599</a>
										</li>
										<li><a href="javascript:;" onclick="fqPrice('600-999')"><i></i>600-999</a>
										</li>
										<li><a href="javascript:;" onclick="fqPrice('1000-1599')"><i></i>1000-1599</a>
										</li>
										<li><a href="javascript:;" onclick="fqPrice('1600')"><i></i>1600以上</a>
										</li>
									</ul>
								</div>
							</div>
				...
				<div class="J_selectorLine s-line">
					<div class="sl-wrap">
						...
						<div class="sl-value">
							<div class="sl-v-list">
								<ul class="J_valueList">
									<li><a href="javascript:;"><i></i>涤纶</a></li>
									<li><a href="javascript:;"><i></i>莫代尔</a></li>
									<li><a href="javascript:;"><i></i>PVC</a></li>
									<li><a href="javascript:;"><i></i>TPE</a></li>
									<li><a href="javascript:;"><i></i>锦纶</a></li>
									<li><a href="javascript:;"><i></i>橡胶</a></li>
									<li><a href="javascript:;"><i></i>竹纤维</a></li>
									<li><a href="javascript:;"><i></i>环保人棉</a></li>
									<li><a href="javascript:;"><i></i>棉麻</a></li>
									<li><a href="javascript:;"><i></i>蚕丝</a></li>
									<li><a href="javascript:;"><i></i>牛奶丝</a></li>
									<li><a href="javascript:;"><i></i>莱卡棉</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="J_selectorLine s-line">
						<div class="sl-wrap">
							...
							<div class="sl-value">
								<div class="sl-v-list">
									<ul class="J_valueList">
										<li><a href="javascript:;" onclick=""><i></i>瑜伽垫</a></li>
										<li><a href="javascript:;" onclick=""><i></i>瑜伽服</a></li>
										<li><a href="javascript:;" onclick=""><i></i>舞蹈鞋服</a></li>
										<li><a href="javascript:;" onclick=""><i></i>其它</a></li>
									</ul>
								</div>
							</div>
						</div>
								...
								<div class="sl-value">
									<div class="sl-v-tab">
										<div class="sl-tab-trigger clearfix">
											<a class="trig-item" href="javascript:;"><span
												class="text">适用人群</span><i class="arrow"></i></a> <a
							...
							<div class="ml-wrap">
								<div id="J_filter" class="filter">
									<div class="f-line top">
										<div class="f-sort">
											<a href="javascript:;" class="curr">综合排序<i></i></a><a
												href="javascript:;" class="">销量<i></i></a><a
												href="javascript:;" class="">价格<i></i></a><a
												href="javascript:;" class="">评论数<i></i></a><a
												href="javascript:;" class="">新品<i></i></a>
										</div>
										<div class="f-search">
											<input type="text" value="在结果中搜索" class="input-txt">
												<a data-type="all" data-field="exp_key"
										...
										<div class="f-result-sum">
											共<span id="J_resCount" class="num">5.6万</span>件商品
										</div>
										<span class="clr"></span>
									</div>
									<div class="f-line">
													...
													<div data-widget="tabs" class="m JD-stock">
														<div class="mt">
															<ul class="tab">
																<li data-index="0" data-widget="tab-item" class=""><a
																	href="javascript:;" class="hover" title="北京"><em>北京</em><i></i></a></li>
																<li data-index="1" data-widget="tab-item" style=""
																	class=""><a href="javascript:;" class=""
																	title="朝阳区"><em>朝阳区</em><i></i></a></li>
																<li data-index="2" data-widget="tab-item" style=""
																	class="curr"><a href="javascript:;" class=""
														...
														<div class="mc" data-area="2" data-widget="tab-content">
															<ul class="area-list">
																...
																<li class="long-area"><a href="javascript:;"
										...
										<div id="J_feature" class="f-feature">
											<ul>
												<li><a data-field="wtype" data-val="1" class=""
													href="javascript:;" onclick="searchlog(1,0,0,43)"><i></i>京东配送</a></li>
												<li><a data-field="cod" data-val="1" class=""
													href="javascript:;" onclick="searchlog(1,0,0,34)"><i></i>货到付款</a></li>
												<li><a data-field="stock" data-val="1" class=""
													href="javascript:;" onclick="searchlog(1,0,0,41)"><i></i>仅显示有货</a></li>
												<li><a data-field="prom_type" data-val="0" class=""
													href="javascript:;" onclick="searchlog(1,0,0,38)"><i></i>促销商品</a></li>
											</ul>
										</div>
										<div id="J_viewType" class="f-type" data-ref="1">
											<a class="ft-item shop" href="javascript:;" data-value="3"
												onclick="searchlog(1,0,0,28)"><i class="i-shop"></i>店铺</a> <a
												class="ft-item grid selected" href="javascript:;"
												data-value="2" onclick="searchlog(1,0,0,45)"><i
												class="i-grid"></i>商品</a>
										</div>
										<span class="clr"></span>
									</div>
								...
								<div id="J_goodsList"
									class="goods-list-v1 gl-type-1 J-goods-list">
												...
												<div class="gl-i-wrap">
													...
													<!-- onclick="window.open('/product/detail?id=${product.id}')" -->
														<a href="javascript:;"
															...
															height="220" class="err-product" src="${product.pic}">
													...
													<div class="p-name p-name-type-2">
														<a target="_blank" title="满129立减10,199减20优惠券,支持货到付款"
															href="javascript:;" onclick="window.open('http://localhost:8083/html/product/${product.id}.html')"> <em>${product.name}</em>
														</a>
													</div>
													<div class="p-commit">
			...
			${page}
						...
						<div class="m-aside">
							<div class="aside-bar">
								<div id="J_promGoodsWrap_6" class="ab-goods"
									style="display: none;">
									<div class="mt">
										<h3>推广商品</h3>
									</div>
									...
									<div class="mc">
										<ul class="clearfix">
											<li>
												<div class="p-img">
													<a href="javascript:;"
														title="依琦莲新款瑜伽服套装 宽松大码女士瑜珈舞蹈服 健身服跳操服 8505长袖黑+红花裤子 L"
														style="position: relative;"> <img width="160"
														height="160" data-img="1" src="/images/ad3.jpg"
														class="err-product">
															<div id="gwd_float_curve_trigger"
																class="gwd_float_curve_trigger gwd_float_curve_up"
																style="left: 40px; top: 49px;">
																<div class="gwd_float_curve_wrapper">
																	<span class="gwd_float_curve_trigger_icon"
																		style="background-image: url(chrome-extension://dobbgecnokkloebjbcnjpgcopegjabpa/images/background_new.png)"></span>
																	<span class="gwd_float_curve_trigger_hint">上涨</span>
												...
												<div class="p-price">
													<span>特价：</span> <strong><em>¥</em><i
														class="J-rec-p-1030027896">148.00</i></strong>
												</div>
												<div class="p-name">
											...
											<li>
												<div class="p-img">
													<a href="javascript:;"
														title="依琦莲新款瑜伽服套装 宽松大码女士瑜珈舞蹈服 健身服跳操服 8505长袖黑+红花裤子 L"
														style="position: relative;"> <img width="160"
														height="160" data-img="1" src="/images/ad2.jpg"
														class="err-product">
															<div id="gwd_float_curve_trigger"
																class="gwd_float_curve_trigger gwd_float_curve_up"
																style="left: 40px; top: 49px;">
											...
											<li>
												<div class="p-img">
													<a href="javascript:;"
														title="依琦莲新款瑜伽服套装 宽松大码女士瑜珈舞蹈服 健身服跳操服 8505长袖黑+红花裤子 L"
														style="position: relative;"> <img width="160"
														height="160" data-img="1"
														src="/images/55237eb5Ndf2c9fcf(1).jpg" class="err-product">
															<div id="gwd_float_curve_trigger"
																class="gwd_float_curve_trigger gwd_float_curve_up"
																style="left: 40px; top: 49px;">
																<div class="gwd_float_curve_wrapper">
											...
											<li>
												<div class="p-img">
													<a href="javascript:;"
														title="依琦莲新款瑜伽服套装 宽松大码女士瑜珈舞蹈服 健身服跳操服 8505长袖黑+红花裤子 L"
														style="position: relative;"> <img width="160"
														height="160" data-img="1" src="/images/ad4.jpg"
														class="err-product">
															<div id="gwd_float_curve_trigger"
																class="gwd_float_curve_trigger gwd_float_curve_up"
																style="left: 40px; top: 49px;">
											...
											<li>
												<div class="p-img">
													<a href="javascript:;"
														title="依琦莲新款瑜伽服套装 宽松大码女士瑜珈舞蹈服 健身服跳操服 8505长袖黑+红花裤子 L"
														style="position: relative;"> <img width="160"
														height="160" data-img="1" src="/images/ad1.jpg"
														class="err-product">
															<div id="gwd_float_curve_trigger"
																class="gwd_float_curve_trigger gwd_float_curve_up"
																style="left: 40px; top: 49px;">
