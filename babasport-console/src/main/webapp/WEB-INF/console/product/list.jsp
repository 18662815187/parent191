<%@page import="cn.itcast.core.bean.product.Product"%>
	...
	<div class="box-positon">
		...
		<form class="ropt">
			<input class="add" type="button" value="添加"
				onclick="window.location.href='toAdd.do'" />
		</form>
		<div class="clear"></div>
	</div>
	<div class="body-box">
				...
				<tbody class="pn-ltbody">
					<c:forEach items="${pagination.list}" var="product">
						<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'"
							...
							<td align="center"><img width="50" height="50" src="${product.images[0]}" onerror="javascript:this.src='${product.pic}'"/></td>
							<td align="center">
							...
							<td align="center"><c:if test="${product.isCommend}">是</c:if> <c:if
									test="${!product.isCommend}">否"</c:if></td>
							<td align="center">
							...
							<td align="center"><a href="#" class="pn-opt">查看</a> | <a
								...
								| <a href="/sku/list.do?productId=${product.id}" class="pn-opt">库存</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
